...
system("module load MariaDB/10.6.4-GCC-10.3.0 && module load UCSC-Utils/448-foss-2021a && faSomeRecords genome1_peptide.fa genespace_genes.txt genespace/peptide/genome2.fa")
