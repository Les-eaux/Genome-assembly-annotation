...
setwd("/data/users/lwuetschert/assembly-annotation-course/genespace")

dat <- fread("orthofinder/Results_Nov19/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
orthogroups <- fread("orthofinder/Results_Nov19/Orthogroups/Orthogroups.GeneCount.tsv")
